...
إذا كنت تريد مغادرة الغرفة ، فاستخدم الأمر *${usedPrefix}مغادره*`, wm, imgplay, [['😎 الإنضمام ', `${usedPrefix + command} ${text}`]], fkontak, m, { mentions: conn.parseMention(text) })
